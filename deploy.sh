...
gcloud functions deploy f_scheduled --entry-point main --runtime python310 --trigger-resource ping_schedule --trigger-event google.pubsub.topic.publish --timeout 540s --region europe-west3 --env-vars-file env-vars.yaml --project stupid-schedule
